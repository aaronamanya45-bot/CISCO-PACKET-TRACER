...
- Perform **basic configuration** (hostnames, IP addresses, VLANs, trunks).
- **Name the devices** for easy identification.
- Ensure **messages can move from one VLAN to another** using a Layer 3 switch.
...
|---|---|---|
| Layer 3 Switch | Cisco 3560-24PS | 2 |
| PC | PC-PT | 6 |
| Cables | Copper Straight-Through | As needed |
